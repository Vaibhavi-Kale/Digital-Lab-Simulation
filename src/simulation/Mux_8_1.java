...
public class Mux_8_1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("8 : 1 MULTIPLEXER");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/8 1 mux- Truth-Table.png"))); // NOI18N
        jScrollPane1.setViewportView(jLabel3);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/8 1  mux.png"))); // NOI18N
        ...
        d4.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        d4.setText("0");
        ...
        d5.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        d5.setText("0");
        ...
        d6.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        d6.setText("0");
        ...
        d7.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        d7.setText("0");
    ...
    public void simulate()
    {
        ...
        String input4 = d0.getText();
        String input5 = d1.getText();
        String input6 = d2.getText();
        String input7 = d3.getText();
        String input8 = d4.getText();
        String input9 = d5.getText();
        String input10 = d6.getText();
        String input11 = d7.getText();       
        //1
