...
public class MasterSlave_FlipFlop extends javax.swing.JFrame {

    public MasterSlave_FlipFlop() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/master slave JK flip flop.png"))); // NOI18N

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(153, 0, 0));
        jLabel1.setText("MASTER SLAVE JK FLIP FLOP");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Master slave flip flop- Truth-Table.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MasterSlave_FlipFlop().setVisible(true);
            }
        });
    }
